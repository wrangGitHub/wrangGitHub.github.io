...
请保留此份 Cmd Markdown 的欢迎稿兼使用说明，如需撰写新稿件，点击顶部工粗体文本具栏右侧的 <i class="icon-file"></i> **新文稿** 或者使用快捷键 `Ctrl+Alt+N`。
...
| 版块ID（int）  主键  3位    | 版块标题（varchar） 20位  |
| --------   | -----:  |
| 01    | 通知公告 |  
| 02       |   通讯录  | 
| 03        |    工作日历   |
...
|主键（int）10位|  版块表ID集合（varchar）50位以上|
| --------   | -----:  |
| 0000001    | 01，02，03，...|  
| 0000002    | 01，05，07，...| 
| 0000003    | 01，10，21，...|
...
>*个人表相应字段
| 个人ID（int/uuid）32位-36位  | 个人版块表主键（int）  |
| --------   | -----:  |
|d4263d6c-302a-404e-94a0-ff5e202aff5d|0000001|  
|9acc482c-45d4-4d78-b1e4-867098586ac7|0000002| 
|040ff8c4-8ac5-4040-af0e-65dae0098045|0000003|
| ：        |    ：   |
| ：        |    ：   |
